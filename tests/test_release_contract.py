...
class ReleaseContractTests(unittest.TestCase):
    ...
    def test_release_version_is_consistent_across_runtime_surfaces(self):
        ...
        self.assertIn("khadamati-app-shell-v1.2.0-r1", text("service-worker.js"))
        self.assertIn("'./assets/scripts/khadamati-ui-state.js'", text("service-worker.js"))
        index_source = text("index.html")
        for asset in (
            "assets/styles/khadamati-v1.css?v=1.2.0-r1",
            "assets/scripts/khadamati-visuals.js?v=1.2.0-r1",
            "assets/scripts/khadamati-ui-state.js?v=1.2.0-r1",
        ):
