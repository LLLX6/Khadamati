...
ALTER TABLE providers ADD COLUMN IF NOT EXISTS governorates JSONB NOT NULL DEFAULT '[]';
...
ALTER TABLE packages ADD COLUMN IF NOT EXISTS lead_delay_seconds INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE packages ADD COLUMN IF NOT EXISTS account_scope TEXT NOT NULL DEFAULT 'all';
ALTER TABLE packages ADD COLUMN IF NOT EXISTS community_package_quota INTEGER NOT NULL DEFAULT 0;
ALTER TABLE packages ADD COLUMN IF NOT EXISTS community_package_days INTEGER NOT NULL DEFAULT 30;
